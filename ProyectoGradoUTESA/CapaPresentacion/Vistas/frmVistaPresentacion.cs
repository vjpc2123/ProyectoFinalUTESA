...
{
    public partial class frmVistaPresentacion : Form
    {
        public frmVistaPresentacion()
        {
            InitializeComponent();
        }
        ...
        private void dtgvListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                frm.setterPresentacion(par1, par2);
                this.Hide();
            }
            catch (Exception)
            {
        ...
        private void frmVistaPresentacion_Load(object sender, EventArgs e)
        {
            MostrarDatos();
            DisDTGV();
        }
