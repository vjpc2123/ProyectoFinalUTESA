...
{
    public partial class frmVistaMarca : Form
    {
        public frmVistaMarca()
        {
            InitializeComponent();
        }
        ...
        private void MostrarDatos()
        {
            try
            {
                dtgvListado.DataSource = NMarca.MostrarMarca();
        ...
        private void BuscarNombre()
        {
            ...
            dtgvListado.DataSource = NMarca.Buscar_Nombre_Marca(mtxtbuscar.Text);
            dtgvListado.Columns[2].Width = 300;
            dtgvListado.Columns[1].Width = 250;
        ...
        private void BuscarDescripcion()
        {
            ...
            dtgvListado.DataSource = NMarca.Buscar_Descripcion_Marca(mtxtbuscar.Text);
            dtgvListado.Columns[2].Width = 300;
            dtgvListado.Columns[1].Width = 250;
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dtgvListado.RowCount);
        }
        ...
        private void frmVistaMarca_Load(object sender, EventArgs e)
        {
            MostrarDatos();
            DisDTGV();
        }
        ...
        private void dtgvListado_KeyPress(object sender, KeyPressEventArgs e)
        {
